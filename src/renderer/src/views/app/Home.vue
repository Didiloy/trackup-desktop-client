    ...
    <div class="w-full h-full overflow-auto px-4 py-6 bg-surface-50">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
            <UserStatCard
                ...
                :value="
                    user_stats_store.get_stats
                        ? formatMinutesToLabel(user_stats_store.get_stats.total_duration)
                        : '0'
                "
                icon="pi pi-clock"
                color="text-blue-500"
            ...
            <UserStatCard
                ...
                :value="
                    user_stats_store.get_stats
                        ? formatMinutesToLabel(user_stats_store.get_stats.avg_session_duration)
                        : '0'
                "
            ...
            <UserStatCard
                ...
                :value="
                    user_stats_store.get_stats
                        ? user_stats_store.get_stats.total_likes_given.toLocaleString()
                        : '0'
                "
                icon="pi pi-heart"
                color="text-pink-500"
            ...
            <UserStatCard
                ...
                :value="
                    user_stats_store.get_stats
                        ? user_stats_store.get_stats.total_sessions.toLocaleString()
                        : '0'
                "
                icon="pi pi-calendar"
                color="text-cyan-500"
            ...
            <UserStatCard
                ...
                :value="
                    user_stats_store.get_stats
                        ? user_stats_store.get_stats.total_unique_activities_played.toLocaleString()
                        : '0'
                "
                icon="pi pi-star"
            ...
            <UserStatCard
                ...
                :value="
                    user_stats_store.get_stats
                        ? user_stats_store.get_stats.total_likes_received.toLocaleString()
                        : '0'
                "
            ...
            <UserStatCard
                ...
                :value="
                    user_stats_store.get_stats?.most_active_server_name ?? t('common.fields.none')
                "
                icon="pi pi-trophy"
            ...
            <UserStatCard
                ...
                :value="
                    user_stats_store.get_stats
                        ? user_stats_store.get_stats.average_session_participants.toFixed(1)
                        : '0'
                "
