        ...
        <div v-else class="space-y-5 max-h-[300px] overflow-y-auto pr-1">
            <div v-for="activity in activities" :key="activity.activity_id" class="group">
                <div class="flex justify-between items-center mb-1.5">
                    <span
                        class="text-sm font-medium text-surface-900 dark:text-surface-50 truncate pr-4"
                    >
                ...
                <div
                    class="h-2 w-full bg-surface-100 dark:bg-surface-700 rounded-full overflow-hidden"
                >
                    <div
