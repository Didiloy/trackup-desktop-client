...
} from '../../shared/contracts/interfaces/snapshot-stats.interfaces'
...
export const snapshotStatsBridge = {
  ...
  getById: (
    ...
    return ipcRenderer.invoke(ipc_channels.snapshotStats.getById, serverId, snapshotId, accessToken)
  },
  ...
  getLatest: (
    ...
    return ipcRenderer.invoke(ipc_channels.snapshotStats.getLatest, serverId, params, accessToken)
  },
